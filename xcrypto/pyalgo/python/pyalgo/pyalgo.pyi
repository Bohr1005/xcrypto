...
def log_info(filename: str, lineno: int, msg: str): ...
def log_debug(filename: str, lineno: int, msg: str): ...
def log_warn(filename: str, lineno: int, msg: str): ...
def log_error(filename: str, lineno: int, msg: str): ...
